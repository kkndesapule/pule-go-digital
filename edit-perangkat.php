  ...
  if(isset($_POST['editBtn']))
    {
        ...
        $saved = mysqli_query($conn, "UPDATE perangkatdesa SET `nama` = '$nama', `img` = '$filename', `jabatan`= '$jabatan' WHERE id =". $_GET["id"]);
        ...
        if($saved){
          move_uploaded_file($tempname, $folder);
            if(mysqli_num_rows($check) > 0)
                ...
                {
                    $_SESSION['show_message'] = 'Perangkat Desa Gagal Diupdate';
                }
        }
    }
?>
...
<html lang="en">
  <head>
    ...
    <?php 
        $sql_query = "SELECT * FROM perangkatdesa WHERE id = ".$_GET["id"];
  ...
  <body id="page-top">
    ...
    <div class="container-fluid mt-5">
        <div class="container">
            ...
            <form class="form" action="edit-perangkat.php?id=<?php echo $id?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" name="jabatan" placeholder="Jabatan Perangkat Desa" aria-label="jabatan" aria-describedby="basic-addon1" value="<?php echo $jabatan;?>">
                </div>
